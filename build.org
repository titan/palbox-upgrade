...
#+begin_src makefile :mkdirp yes :tangle /dev/shm/upgrade/libopencm3.rules.mk
  ##
...
#+begin_src makefile :mkdirp yes :tangle /dev/shm/upgrade/libopencm3.target.mk
  ##
  ## This file is part of the libopencm3 project.
  ##
  ## Copyright (C) 2009 Uwe Hermann <uwe@hermann-uwe.de>
...
#+begin_src makefile :mkdirp yes :tangle /dev/shm/upgrade/stm32f0.ld
...
** Makefile
#+begin_src makefile :mkdirp yes :tangle /dev/shm/upgrade/Makefile
  BINARY = upgrade
  OBJS += ring.o repl-fsm.o repl-lex-fsm.o w25x16.o repl.o stack.o uart.o utility.o led.o packet.o parameter.o ec20-lex-fsm.o ec20-syntax-fsm.o ec20-boot-fsm.o ec20-udp-fsm.o ec20-http-fsm.o ec20.o

  CFLAGS = -DAPIVERSION=1 -DZEROPACK_PARAMETER_ENABLED -DAPN=CMMTM
